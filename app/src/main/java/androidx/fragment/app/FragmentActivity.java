...
public class FragmentActivity extends ComponentActivity implements
    ...
    static final class NonConfigurationInstances {
        Object custom;
        ViewModelStore viewModelStore; // TODO 这个内部类中存在 ViewModelStore
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        @SuppressLint("RestrictedApi") ActivityCompat.PermissionCompatDelegate delegate =
    ...
    public ViewModelStore getViewModelStore() {
        ...
        if (mViewModelStore == null) {
            ...
            if (mViewModelStore == null) {  // 为空就新创建一个
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // ViewModelStore 对象是保存在 NonConfigurationInstances 中
     ...
     * TODO onRetainNonConfigurationInstance
     */
    @Override
